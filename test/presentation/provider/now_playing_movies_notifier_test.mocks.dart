...
// in ditonton/test/presentation/provider/now_playing_movies_notifier_test.dart.
...
class MockGetNowPlayingMovies extends _i1.Mock
  ...
  @override
  _i5.Future<_i3.Either<_i6.Failure, List<_i7.Movie>>> execute(bool? isMovie) =>
      (super.noSuchMethod(Invocation.method(#execute, [isMovie]),
              returnValue:
                  _i5.Future<_i3.Either<_i6.Failure, List<_i7.Movie>>>.value(
                      _FakeEither_1<_i6.Failure, List<_i7.Movie>>(
                          this, Invocation.method(#execute, [isMovie]))))
