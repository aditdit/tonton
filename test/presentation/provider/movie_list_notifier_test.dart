...
void main() {
  ...
  group('now playing movies', () {
    ...
    test('should get data from the usecase', () async {
      ...
      // act
      provider.fetchNowPlayingMovies(true);
      // assert
    ...
    test('should change movies when data is gotten successfully', () async {
      ...
      when(mockGetNowPlayingMovies.execute(true))
          .thenAnswer((_) async => Right(tMovieList));
      // act
      await provider.fetchNowPlayingMovies(true);
      // assert
  ...
  group('popular movies', () {
    test('should change state to loading when usecase is called', () async {
      ...
      when(mockGetPopularMovies.execute(true))
          .thenAnswer((_) async => Right(tMovieList));
      // act
      provider.fetchPopularMovies(true);
      // assert
    ...
    test('should change movies data when data is gotten successfully',
      ...
      when(mockGetPopularMovies.execute(true))
          .thenAnswer((_) async => Right(tMovieList));
      // act
      await provider.fetchPopularMovies(true);
      // assert
  ...
  group('top rated movies', () {
    test('should change state to loading when usecase is called', () async {
      ...
      when(mockGetTopRatedMovies.execute(true))
          .thenAnswer((_) async => Right(tMovieList));
      // act
      provider.fetchTopRatedMovies(true);
      // assert
    ...
    test('should change movies data when data is gotten successfully',
      ...
      when(mockGetTopRatedMovies.execute(true))
          .thenAnswer((_) async => Right(tMovieList));
      // act
      await provider.fetchTopRatedMovies(true);
      // assert
